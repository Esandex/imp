		...
		<?php foreach ($users->result() as $user) { ?>	
			<div class="card small col s12 m6 l3">
			    ...
			    <div class="card-content">
			      ...
			      <p><a href="usuarios/permisos/<?= $user->id_user ?>">editar permisos</a></p>
			    </div>
...
<div class="fixed-action-btn">
	<a href="usuarios/nuevo" class="btn-floating btn-large waves-effect waves-light purple lighten-1"><i class="material-icons">add</i></a>
</div>
